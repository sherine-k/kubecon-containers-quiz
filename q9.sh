...
pe "oras attach 79353h8v.c1.de1.container-registry.ovh.net/public/gophers-api:latest --artifact-type application/vnd.goharbor.harbor.sbom.v1 /tmp/result.json:application/vnd.goharbor.harbor.sbom.v1 --annotation \"org.opencontainers.artifact.description=SPDX JSON SBOM\" --disable-path-validation"
